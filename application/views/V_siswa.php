    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <h2 data-aos="fade-up" data-aos-delay="400">Hai, <?php echo $nama; ?> ! Belajar ERD dengan materi yang mudah dipahami dan media pembelajaran yang mudah untuk digunakan, yuk!</h2>
